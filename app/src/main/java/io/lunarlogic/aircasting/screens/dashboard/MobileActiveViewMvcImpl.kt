...
class MobileActiveViewMvcImpl : BaseObservableViewMvc<MobileActiveViewMvc.Listener>, MobileActiveViewMvc, ActiveSessionViewMvc.Listener {
    private var mRecordSessionButton: Button? = null

    private var mRecyclerSessions: RecyclerView? = null
    private var mEmptyView: View? = null
    private val mAdapter: MobileActiveRecyclerAdapter
    ...
    constructor(
        ...
        mAdapter = MobileActiveRecyclerAdapter(
            inflater,
            this
        )
