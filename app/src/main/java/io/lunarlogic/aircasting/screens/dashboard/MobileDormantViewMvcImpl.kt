...
class MobileDormantViewMvcImpl : BaseObservableViewMvc<MobileDormantViewMvc.Listener>, MobileDormantViewMvc, DormantSessionViewMvc.Listener {
    private var mRecordSessionButton: Button? = null

    private var mRecyclerSessions: RecyclerView? = null
    private var mEmptyView: View? = null
    private val mAdapter: MobileDormantRecyclerAdapter

    constructor(
        inflater: LayoutInflater, parent: ViewGroup?): super() {
        this.rootView = inflater.inflate(R.layout.fragment_mobile_active, parent, false)
        ...
        mAdapter = MobileDormantRecyclerAdapter(
            inflater,
            this
        )
