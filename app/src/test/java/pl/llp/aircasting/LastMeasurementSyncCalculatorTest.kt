...
class LastMeasurementSyncCalculatorTest {
    val sessionEndTime = DateConverter.get()?.fromString("1987-07-23T11:00:00")

    @Test
    fun lastMeasurementTimeBlankTest() {
        Assert.assertEquals(
            DateConverter.get()?.fromString("1987-07-22T11:00:00"),
    ...
    fun lastMeasurementTimePresentAndInThe24HoursTimeFrameTest() {
        val lastMeasurementTime = DateConverter.get()?.fromString("1987-07-22T17:00:00")
        Assert.assertEquals(
            DateConverter.get()?.fromString("1987-07-22T17:00:00"),
    ...
    fun lastMeasurementTimePresentButOlderThan24HoursTimeFrameTest() {
        val lastMeasurementTime = DateConverter.get()?.fromString("1987-07-21T11:00:00")
        Assert.assertEquals(
            DateConverter.get()?.fromString("1987-07-22T11:00:00"),
            LastMeasurementSyncCalculator.calculate(sessionEndTime, lastMeasurementTime)
        )
