...
import pl.llp.aircasting.data.api.util.StringConstants.airbeam2sensorName
...
class ThresholdAlertUiRepresentationTest {
    ...
    fun getStreamTitle_returnsDetailedTypeOfStream() {
        val stream = mock<MeasurementStream> {
            ...
            on { sensorName } doReturn airbeam2sensorName
        }
    ...
    @Test
    fun copy() {
        val uiAlert = ThresholdAlertUiRepresentation(mock(), airbeam2sensorName)
