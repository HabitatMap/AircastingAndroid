    ...
    fun mobile_read_whenFrequencyIs5_buildsAveragedMeasurementCorrectly() =
        runTest {
            ...
            val firstResultFahrenheitAverage =
                csvSession!!.streams[CSVSession.LineParameter.F.position]!![0]
            val secondResultFahrenheitAverage =
                csvSession.streams[CSVSession.LineParameter.F.position]!![1]
            val firstResultRHAverage =
                csvSession.streams[CSVSession.LineParameter.RH.position]!![0]
            val secondResultRHAverage =
                csvSession.streams[CSVSession.LineParameter.RH.position]!![1]
